...
public class ContactProgram {
    public static void Connection(String login, String password) {
        ...
        try (BufferedReader reader = Files.newBufferedReader(Paths.get("C:\\Users\\nasss\\IdeaProjects\\ZadanieVClasse-main\\out\\production\\ZadanieVClasse-main\\ggg.txt"))) {
            String line;
        ...
        try (Connection connection = getConnection(String.valueOf(jdbcURL), login, password)) {
